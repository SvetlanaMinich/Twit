...
@dso_cache = dso_local local_unnamed_addr global [1126 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 312088335, ; hash 0x129a170f, from name: aot-TwitterAnal.UI
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 341319133, ; hash 0x14581ddd, from name: libaot-MediatR.Contracts.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 352435129, ; hash 0x1501bbb9, from name: aot-TwitterAnal.Application.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 381034137, ; hash 0x16b61e99, from name: libaot-MediatR.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 403493213, ; hash 0x180cd15d, from name: MediatR.Contracts
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.18_name, ; name: libaot-MediatR.Contracts.dll.so
		ptr null; void* handle (0x0)
	}, ; 109
	...
	%struct.DSOCacheEntry {
		i64 735635650, ; hash 0x2bd8e8c2, from name: aot-MediatR.Contracts
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.18_name, ; name: libaot-MediatR.Contracts.dll.so
		ptr null; void* handle (0x0)
	}, ; 185
	...
	%struct.DSOCacheEntry {
		i64 837166451, ; hash 0x31e62573, from name: TwitterAnal.Persistense
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 848370320, ; hash 0x32911a90, from name: libaot-MediatR
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.17_name, ; name: libaot-MediatR.dll.so
		ptr null; void* handle (0x0)
	}, ; 215
	...
	%struct.DSOCacheEntry {
		i64 1008944279, ; hash 0x3c234497, from name: aot-TwitterAnal.UI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libaot-TwitterAnal.UI.dll.so
		ptr null; void* handle (0x0)
	}, ; 248
	...
	%struct.DSOCacheEntry {
		i64 1113123738, ; hash 0x4258eb9a, from name: TwitterAnal.Application
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TwitterAnal.Application.dll.so
		ptr null; void* handle (0x0)
	}, ; 268
	...
	%struct.DSOCacheEntry {
		i64 1274804085, ; hash 0x4bfbf775, from name: libaot-TwitterAnal.UI
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libaot-TwitterAnal.UI.dll.so
		ptr null; void* handle (0x0)
	}, ; 308
	...
	%struct.DSOCacheEntry {
		i64 1414863863, ; hash 0x54551bf7, from name: aot-TwitterAnal.Domain.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1557803463, ; hash 0x5cda31c7, from name: libaot-TwitterAnal.Persistense
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-TwitterAnal.Persistense.dll.so
		ptr null; void* handle (0x0)
	}, ; 388
	...
	%struct.DSOCacheEntry {
		i64 1601887445, ; hash 0x5f7adcd5, from name: TwitterAnal.Domain.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TwitterAnal.Domain.dll.so
		ptr null; void* handle (0x0)
	}, ; 394
	...
	%struct.DSOCacheEntry {
		i64 1641358052, ; hash 0x61d522e4, from name: MediatR.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.17_name, ; name: libaot-MediatR.dll.so
		ptr null; void* handle (0x0)
	}, ; 409
	...
	%struct.DSOCacheEntry {
		i64 1827458547, ; hash 0x6ceccdf3, from name: TwitterAnal.Domain
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TwitterAnal.Domain.dll.so
		ptr null; void* handle (0x0)
	}, ; 466
	...
	%struct.DSOCacheEntry {
		i64 1943399026, ; hash 0x73d5ea72, from name: libaot-TwitterAnal.Application
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TwitterAnal.Application.dll.so
		ptr null; void* handle (0x0)
	}, ; 495
	...
	%struct.DSOCacheEntry {
		i64 2075208543, ; hash 0x7bb12b5f, from name: aot-TwitterAnal.Persistense
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-TwitterAnal.Persistense.dll.so
		ptr null; void* handle (0x0)
	}, ; 536
	...
	%struct.DSOCacheEntry {
		i64 2207164342, ; hash 0x838ea7b6, from name: libaot-MediatR.Contracts
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.18_name, ; name: libaot-MediatR.Contracts.dll.so
		ptr null; void* handle (0x0)
	}, ; 567
	...
	%struct.DSOCacheEntry {
		i64 2434246527, ; hash 0x9117a77f, from name: libaot-TwitterAnal.Domain.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TwitterAnal.Domain.dll.so
		ptr null; void* handle (0x0)
	}, ; 631
	...
	%struct.DSOCacheEntry {
		i64 2615519321, ; hash 0x9be5a859, from name: MediatR
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.17_name, ; name: libaot-MediatR.dll.so
		ptr null; void* handle (0x0)
	}, ; 677
	...
	%struct.DSOCacheEntry {
		i64 2761203288, ; hash 0xa4949e58, from name: libaot-TwitterAnal.Application.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TwitterAnal.Application.dll.so
		ptr null; void* handle (0x0)
	}, ; 719
	...
	%struct.DSOCacheEntry {
		i64 2962337766, ; hash 0xb091afe6, from name: libaot-TwitterAnal.UI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libaot-TwitterAnal.UI.dll.so
		ptr null; void* handle (0x0)
	}, ; 768
	...
	%struct.DSOCacheEntry {
		i64 3070224510, ; hash 0xb6ffe87e, from name: TwitterAnal.UI
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libaot-TwitterAnal.UI.dll.so
		ptr null; void* handle (0x0)
	}, ; 802
	...
	%struct.DSOCacheEntry {
		i64 3113346018, ; hash 0xb991e3e2, from name: libaot-TwitterAnal.Persistense.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-TwitterAnal.Persistense.dll.so
		ptr null; void* handle (0x0)
	}, ; 812
	...
	%struct.DSOCacheEntry {
		i64 3271839031, ; hash 0xc3044d37, from name: aot-MediatR.Contracts.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.18_name, ; name: libaot-MediatR.Contracts.dll.so
		ptr null; void* handle (0x0)
	}, ; 853
	...
	%struct.DSOCacheEntry {
		i64 3337075227, ; hash 0xc6e7ba1b, from name: aot-TwitterAnal.Persistense.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-TwitterAnal.Persistense.dll.so
		ptr null; void* handle (0x0)
	}, ; 872
	...
	%struct.DSOCacheEntry {
		i64 3426513471, ; hash 0xcc3c723f, from name: MediatR.Contracts.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.18_name, ; name: libaot-MediatR.Contracts.dll.so
		ptr null; void* handle (0x0)
	}, ; 897
	...
	%struct.DSOCacheEntry {
		i64 3529588344, ; hash 0xd2613e78, from name: aot-TwitterAnal.Application
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TwitterAnal.Application.dll.so
		ptr null; void* handle (0x0)
	}, ; 912
	...
	%struct.DSOCacheEntry {
		i64 3594406170, ; hash 0xd63e491a, from name: TwitterAnal.Application.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TwitterAnal.Application.dll.so
		ptr null; void* handle (0x0)
	}, ; 935
	...
	%struct.DSOCacheEntry {
		i64 3626714213, ; hash 0xd82b4465, from name: TwitterAnal.Persistense.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-TwitterAnal.Persistense.dll.so
		ptr null; void* handle (0x0)
	}, ; 945
	...
	%struct.DSOCacheEntry {
		i64 3896473448, ; hash 0xe83f7768, from name: aot-MediatR
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.17_name, ; name: libaot-MediatR.dll.so
		ptr null; void* handle (0x0)
	}, ; 1006
	...
	%struct.DSOCacheEntry {
		i64 3942340808, ; hash 0xeafb58c8, from name: libaot-TwitterAnal.Domain
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TwitterAnal.Domain.dll.so
		ptr null; void* handle (0x0)
	}, ; 1022
	...
	%struct.DSOCacheEntry {
		i64 3949369777, ; hash 0xeb6699b1, from name: aot-MediatR.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.17_name, ; name: libaot-MediatR.dll.so
		ptr null; void* handle (0x0)
	}, ; 1025
	...
	%struct.DSOCacheEntry {
		i64 3959345336, ; hash 0xebfed0b8, from name: aot-TwitterAnal.Domain
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-TwitterAnal.Domain.dll.so
		ptr null; void* handle (0x0)
	}, ; 1030
	...
	%struct.DSOCacheEntry {
		i64 4039555899, ; hash 0xf0c6bb3b, from name: TwitterAnal.UI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libaot-TwitterAnal.UI.dll.so
		ptr null; void* handle (0x0)
	}, ; 1053
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [227 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
